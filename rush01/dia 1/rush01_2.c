...
/*   Updated: 2019/10/12 19:27:34 by bmoran-f         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(void)
{
	int col1up=3,col2up=1, col3up=2, col4up=3, row1right=3, row2right=2, row3right=1, row4right=2;
	int col1down=1, col2down=4, col3down=2, col4down=2, row1left=2, row2left=3, row3left=2, row4left=1;
	int matrix[4][4];
	int i=0, j=0;
